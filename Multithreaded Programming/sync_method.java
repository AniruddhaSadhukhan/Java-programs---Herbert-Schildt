...
//Program to understand Synchronized Methods
//		by Aniruddha

class Callme
{
	/* While a thread is inside a synchronized method, all other 
	threads that try to call it on the same instance have to wait */
...
/*Sample Output without synchronized method:
Starting Thread: One
One : 5
Starting Thread: Two
Two : 5
...
/*Sample Output with synchronized method:
